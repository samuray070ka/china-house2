    ...
    <div className="container">
      <div className="contact">
        ...
        <div className="con__sidebar">
          ...
          <img className='csidebar__loc' src="https://china-house.uz/wp-content/themes/china-house/images/sales/shohsaroy.jpg" alt="" />

          <br />
          <h4>Посмотреть на карте</h4>

          <img className='csidebar__logo' src="https://china-house.uz/wp-content/themes/china-house/images/sales/logo-shanghai-white2.svg" alt="" />

          <img className='csidebar__loc' src="https://china-house.uz/wp-content/themes/china-house/images/sales/shanghai.jpg" alt="" />
          <h4>Посмотреть на карте</h4>
        </div>
        ...
        <div className="con__about">
          {
            MAN__ABOUT?.map((item, inx)=><div key={inx} className="cabout__card">
              ...
              <h4 className='ccard__job'>
                {item.job}
              </h4>

              <button className='ccard__btn'>
                Xabar yozish uchun
              </button>

            <h4 className='ccard__num'>+998 <span>{item.num}</span></h4>
            </div>)
          }
